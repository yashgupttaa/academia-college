            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="max-w-3xl hero-content">
                ...
                <p className="text-lg mb-8 text-white/90 max-w-lg">
                  ...
                  IILM University, Greater Noida, offers a transformative
        ...
        <section className="bg-[#F2F2F2]">
          <div className="container mx-auto px-4 py-16">
            ...
            {/* <p className="text-xl font-semibold mb-4 red-color">
              IILM University focuses on building strong leadership through
              excellence in teaching and research.
            </p> */}
            <p className="text-gray-600 text-base my-8">
              The Bachelor of Business Administration (BBA) programme at IILM
              University, Greater Noida, offers a transformative business
            ...
            <p className="text-gray-600 text-base mb-8">
              At IILM, the programme integrates core management principles with
            ...
            <p className="text-gray-600 text-base mb-8">
              ...
              education, and industry engagement, the IILM BBA prepares you for
